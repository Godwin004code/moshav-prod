...
const FIS = () => {
  ...
  return (
    <>
    <Nav />
<section className='landing-page-about h-[70vh] sm:h-[40vh] w-full pt-20 md:pt-14 pb-0' style={{backgroundImage: `url(${bg})`, backgroundPosition: 'center', backgroundSize: 'cover'}}>
    <section className='w-[90%] mx-auto h-[90%] sm:h-[100%]' style={{backgroundImage: `url(${bg2})`, backgroundPosition: '', backgroundSize: '', borderRadius: '5px'}}>
