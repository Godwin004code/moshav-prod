...
const CollateralWarehousing = () => {
  return (
    <>
    <Nav />
<section className='landing-page-about h-[70vh]  sm:h-[50vh] w-full pt-20 md:pt-14 pb-0' style={{backgroundImage: `url(${bg})`, backgroundPosition: 'center', backgroundSize: 'cover'}}>
