...
const ClusterMarketingServices = () => {
  ...
  return (
    ...
    <>
    <Nav />
<section className='landing-page-about sm:h-[50vh] h-[70vh] w-full pt-20 md:pt-14 pb-0' style={{backgroundImage: `url(${bg})`, backgroundPosition: 'center', backgroundSize: 'cover'}}>
