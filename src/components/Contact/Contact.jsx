...
<h2 className='my-7 font-normal text-2xl sm:text-lg'>Office Locations</h2>
<p className='font-semibold text-2xl sm:text-base'>27 Old Gloucester Street, London.</p>
<p className='font-semibold text-2xl sm:text-base w-[80%] mx-auto text-center'>Mulliner Towers, 39 Alfred Rewane Road, Ikoyi Lagos.</p>
      </div>
      <div style={{border: '1px solid #1E772C'}} className='flex rounded-[5px] flex-col justify-center w-full items-center py-7'>
...
<p className='font-semibold text-2xl sm:text-base  underline'>contact@moshavcapital.com</p>
      </div>
      ...
      <form className='bg-[#E9F1E1] w-[80%] sm:w-[90%] mx-auto py-16 sm:py-10 px-14 sm:px-3'>
        ...
        <div className='w-full flex justify-between mb-12 sm:mb-[16px]'>
          ...
          <select className='category-select pl-6 w-full h-[60px] rounded-[10px] pr-6 bg-[#FFFFFF] focus:outline-none' name="category" id="category">
            <option value="Financial Intermediation" className='pl-6'>Financial Intermediation</option>
            <option value="Commodities Warehousing">Commodities Warehousing</option>
            <option value="Collateral Management">Collateral Management</option>
            <option value="Logistics">Logistics</option>
            <option value="Shared Infrastructure-As-A-Service Provisioning">Shared Infrastructure-As-A-Service Provisioning</option>
            <option value="Cluster Marketing Support">Cluster Marketing Support</option>
            <option value="Commodities Brokerage Services">Commodities Brokerage Services</option>
          </select>
        </div>
        <div>
