...
import david from "../../Assets/IMG_0244.JPG";
import Aishat from "../../Assets/IMG_0242.JPG";
import mohammad from "../../Assets/IMG_0243.JPG";
      ...
      <div className="w-[80%] mx-auto flex justify-between lg:flex-col lg:mt-[60px]">
        ...
        <div className="flex relative mr-[100px] lg:hidden">
          <div className="rounded-xl opacity-0">
            <img src={Jessica} className="" alt="" />
          </div>
          <div className="absolute flex h-full w-[400%]">
            {testimonials.map((testimonial) => {
              return (
                <div className="rounded-xl testimonial-cards">
                  <img className="w-full h-full max-w-[300px] object-cover overflow-hidden rounded-xl" src={testimonial.image} alt="" />
                </div>
              );
            })}
          </div>
