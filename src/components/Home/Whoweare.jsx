...
const Whoweare = () => {
  return (
    <section className="w-full bg-[#FAFFF5] py-10">
      <h2 className="text-[#000000] text-4xl sm:text-3xl w-[80%] sm:w-[90%] mx-auto font-bold md-2:mb-10">
        Who We Are
      </h2>
      <div className="flex justify-between w-[80%] sm:w-[90%] mx-auto md-2:flex-col-reverse">
        <div className="w-[45%] md-2:w-[90%] sm:w-[100%]  mt-20">
          <p className="text-lg sm:text-base leading-[35px] ">
        ...
        <div className="w-[45%] md-2:w-[90%] sm:w-[100%] md-2:max-w-[500px]">
          <img
            src={img}
