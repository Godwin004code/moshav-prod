...
const Vision = () => {
  return (
    <section className='w-full mt-4' style={{backgroundImage: `url(${img})`, backgroundPosition: 'center', backgroundSize: 'cover'}}>
...
<div className='w-[2px] h-[80px] sm:w-[1px] sm:h-[47px] bg-white mt-5'></div>
<div className='w-[15px] h-[15px] bg-white rounded-full my-7'></div>
<div className='w-[2px] h-[80px] sm:w-[1px] sm:h-[47px] bg-white mb-5'></div>
